...
class _AssetReturnScreenState extends State<AssetReturnScreen> with SingleTickerProviderStateMixin {
  ...
  int _rowsPerPage = 10;
  int _currentPage = 0;
  List<AssetReturnModel> _dateFilteredHistory = [];
    ...
    setState(() {
      ...
      if (query.isEmpty) {
        ...
        _filteredHistory = _dateFilteredHistory.where((request) => 
          ...
          (request.assetName.toLowerCase().contains(query))
        ).toList();
      }
      _currentPage = 0;
    });
          ...
          children: [
            ...
            Container(
              ...
              child: Column(
                crossAxisAlignment: CrossAxisAlignment.start,
                children: [
                  const Text('Asset Return History', style: TextStyle(fontSize: 16, fontWeight: FontWeight.bold)),
                  const SizedBox(height: 20),
  ...
  Widget _buildHistoryCards() {
    ...
    List<AssetReturnModel> displayedItems = _filteredHistory.take(displayCount).toList();
  ...
  Widget _buildHistoryCard(AssetReturnModel item) {
    return Container(
        ...
        children: [
          ...
          Row(
            children: [
              ...
              _buildCardItem('ASSET NAME', item.assetName, flex: 2),
            ],
          ),
